...
(function (global, factory) {
  ...
  /* Loop Studio (loopstudio.app) recolor: every hex below is copied verbatim from this
     brand's own design tokens in css/loopstudio-app.webflow.shared.min.css
     (--base-color-brand--secondary, --base-color-brand--primary, --base-color-brand--pink,
     --base-color-brand--blue-light, --base-color-neutral--*) — no new hex value is introduced
     for this module, per the landing-page spec's design-token decision. Replaces the
     onlinemedianer.de example's own navy/blue/teal/sand/gold palette. */
  var GRUND = {
    /*        Basis      hell       dunkel     Schrift    versatz */
    navy:  ['#273ea2', '#d9e5ff', '#111111', '#FFFFFF', 0.00],
    blue:  ['#273ea2', '#d9e5ff', '#222222', '#FFFFFF', 0.00],
    teal:  ['#1ba17b', '#eeeeee', '#111111', '#FFFFFF', 0.04],
    sand:  ['#cccccc', '#eeeeee', '#666666', '#1a1a1c', 0.30],
    creme: ['#fafafa', '#FFFFFF', '#aaaaaa', '#1a1a1c', 0.34],
    /* gold ist NICHT im Marken-Set; ersetzt durch den dritten Markenakzent (Pink). */
    gold:  ['#dd23bb', '#ffaefe', '#3c043b', '#FFFFFF', 0.14]
  };
